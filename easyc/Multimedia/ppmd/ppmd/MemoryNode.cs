...
namespace PpmdSharp
{
    ...
    internal struct MemoryNode
    {
        ...
        public static readonly MemoryNode Zero = new MemoryNode(0);
        ...
        {
            get { return new MemoryNode(((uint) Memory[Address + 4]) | ((uint) Memory[Address + 5]) << 8 | ((uint) Memory[Address + 6]) << 16 | ((uint) Memory[Address + 7]) << 24); }
            set
            {
