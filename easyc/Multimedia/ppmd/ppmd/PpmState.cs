...
namespace PpmdSharp
{
    ...
    internal struct PpmState
    {
        ...
        public static readonly PpmState Zero = new PpmState(0);
        ...
        {
            get { return new Model.PpmContext(((uint) Memory[Address + 2]) | ((uint) Memory[Address + 3]) << 8 | ((uint) Memory[Address + 4]) << 16 | ((uint) Memory[Address + 5]) << 24); }
            set
            {
        ...
        {
            get { return new PpmState((uint) (Address + offset * Size)); }
        }
